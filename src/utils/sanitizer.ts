...
export function sanitizeString(str: string, options: { maxLength?: number } = {}): string {
 ...
 */
export function sanitizeObject(input: any, options: { maxStringLength?: number; allowedKeysRegex?: RegExp | null; removeEmpty?: boolean } = {}): any {
 ...
 */
export function sanitizeMiddleware(options: any = {}) {
